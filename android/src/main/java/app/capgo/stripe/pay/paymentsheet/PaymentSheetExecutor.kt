...
class PaymentSheetExecutor(
    ...
    fun createPaymentSheet(call: PluginCall) {
        ...
        stripeAccountId = call.getString("stripeAccount", null)
    ...
    fun presentPaymentSheet(call: PluginCall) {
        try {
            val publishableKey = com.stripe.android.PaymentConfiguration.getInstance(contextSupplier.get()).publishableKey
            if (stripeAccountId != null) {
                com.stripe.android.PaymentConfiguration.init(contextSupplier.get(), publishableKey, stripeAccountId)
            }
    ...
    fun onPaymentSheetResult(
        ...
        val resultKey = when (paymentSheetResult) {
            ...
            is PaymentSheetResult.Completed -> PaymentSheetEvents.Completed.webEventName
            else -> null
        }
        ...
        when (paymentSheetResult) {
            ...
            is PaymentSheetResult.Failed -> {
                notifyListenersFunction.accept(
                    ...
                    JSObject().put("message", paymentSheetResult.error.localizedMessage)
                )
            }
